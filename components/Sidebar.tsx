...
import { CommunityIcon, ClassroomIcon, DownloadIcon, SettingsIcon } from './icons';

export const Sidebar: FC<{ currentView: View; setView: (view: View) => void }> = ({ currentView, setView }) => {
    const navItems: { view: View; label: string; icon: FC<any> }[] = [
